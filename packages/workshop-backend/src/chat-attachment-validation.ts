...
// chat-attachment-pdf.ts). Workers AI and Ollama chat endpoints have no document input at all, and
// DeepSeek's chat models are text-only (their catalog `input` is `["text"]`).
